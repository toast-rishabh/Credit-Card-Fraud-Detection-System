...
The dataset is taken from the Kaggle Website( https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud ) and it has a total of 2,84,807 transactions, out of which 492 are fraudulent. Since the dataset is highly imbalanced, so it needs to be handled before model building.
